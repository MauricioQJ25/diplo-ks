/*
 * Driver para el acelerómetro
 * MPU3050 
 * Preliminar, aún falta registro en /dev, 
 * pero lo podemos observar en /sys/bus/i2c/drivers/mpu3050 :)
 * Falta modificar rutinas de lecturas.
 */
			       ...
			       u8 *buffer, int length)
{
    ...
    printk(KERN_INFO "Reading register!\n");
...
static irqreturn_t mpu3050_interrupt_thread(int irq, void *data)
{
    ...
    printk(KERN_INFO "Interrupt thread!\n");
	return IRQ_HANDLED;
}
...
MODULE_AUTHOR("Mauricio Quijada <mauricio.quijada@outlook.com>");
MODULE_DESCRIPTION("MPU3050 acelerómetro, giroscopio y sensor temperatura");
MODULE_LICENSE("GPL");
